...
Розробка сценаріїв: Створила розгалужену систему відповідей, адаптовану під різні поведінкові архетипи (зокрема "Локомотив", "Дипломат", "Виконавець", "Маніпулятор").
